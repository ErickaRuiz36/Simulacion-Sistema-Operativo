...
AUTORES: 	Edgardo Adrián Franco Martínez (C) Marzo 2017
...
int Search(cola *c, elemento e);	//Busca la posicion de un elemento y regresa un entero que seria el numero en que se encuentra dicho elemento
void Flip(cola *c);					//Invierte los elementos de la cola
